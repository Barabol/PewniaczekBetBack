...
public class ScoreBetDto {
	...
	public static ScoreBetDto fromEntity(ScoreBetEntity entity) {
		ScoreBetDto dto = new ScoreBetDto();
	...
	public static List<ScoreBetDto> fromEntity(List<ScoreBetEntity> entities) {
		return entities.stream().map(ScoreBetDto::fromEntity).toList();
	}
